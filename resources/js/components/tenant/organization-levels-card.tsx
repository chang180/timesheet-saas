...
export function OrganizationLevelsCard({
    ...
    const [pendingForceRemoveLevels, setPendingForceRemoveLevels] = useState<
        string[]
    >([]);
    ...
    return (
        <>
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-4">
                            {(['division', 'department', 'team'] as const).map(
                                (level) => {
                                    const isChecked =
            ...
            <Dialog
                open={forceRemoveConfirmOpen}
                onOpenChange={setForceRemoveConfirmOpen}
            >
                <DialogContent>
                    <DialogHeader>
